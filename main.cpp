...
int main(int argc, char** argv) {
    ...
    // ----------------------------------------------------
    int validation_result = forward_validate("data/input_tokens_null.txt", "data/image_path_null.txt", "data/output_tokens_full_null.txt", tokenizer, config, weights, state);
