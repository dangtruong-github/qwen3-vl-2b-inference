        ...
        for (size_t kk = 0; kk < K; kk += TK) {
            ...
            for (size_t ii = 0; ii < M; ++ii) {
                ...
                if (kk == 0) {
                    ...
                    c0 = _mm256_load_ps(c0_ptr);
                    c1 = _mm256_load_ps(c0_ptr + 8);
                    c2 = _mm256_load_ps(c0_ptr + 16);
                    c3 = _mm256_load_ps(c0_ptr + 24);
                    c4 = _mm256_load_ps(c0_ptr + 32);
                    c5 = _mm256_load_ps(c0_ptr + 40);
                    c6 = _mm256_load_ps(c0_ptr + 48);
                    c7 = _mm256_load_ps(c0_ptr + 56);
                }
                ...
                _mm256_store_ps(c0_ptr, c0);
                _mm256_store_ps(c0_ptr + 8, c1);
                _mm256_store_ps(c0_ptr + 16, c2);
                _mm256_store_ps(c0_ptr + 24, c3);
                _mm256_store_ps(c0_ptr + 32, c4);
                _mm256_store_ps(c0_ptr + 40, c5);
                _mm256_store_ps(c0_ptr + 48, c6);
                _mm256_store_ps(c0_ptr + 56, c7);
            }
        }
    
        #pragma omp for schedule(static)
        for (size_t ii = 0; ii < M; ++ii) {
            const size_t stride = (ii << 6);
            float *c_ptr = packed_C + stride;
            half_cpu *out_ptr = mat_C + stride;

            __m256 c0 = _mm256_load_ps(c_ptr);
            __m256 c1 = _mm256_load_ps(c_ptr + 8);
            __m256 c2 = _mm256_load_ps(c_ptr + 16);
            __m256 c3 = _mm256_load_ps(c_ptr + 24);
            __m256 c4 = _mm256_load_ps(c_ptr + 32);
            __m256 c5 = _mm256_load_ps(c_ptr + 40);
            __m256 c6 = _mm256_load_ps(c_ptr + 48);
            __m256 c7 = _mm256_load_ps(c_ptr + 56);

            _mm_storeu_si128((__m128i*)(out_ptr),      _mm256_cvtps_ph(c0, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 8),  _mm256_cvtps_ph(c1, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 16), _mm256_cvtps_ph(c2, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 24), _mm256_cvtps_ph(c3, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 32), _mm256_cvtps_ph(c4, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 40), _mm256_cvtps_ph(c5, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 48), _mm256_cvtps_ph(c6, _MM_FROUND_CUR_DIRECTION));
            _mm_storeu_si128((__m128i*)(out_ptr + 56), _mm256_cvtps_ph(c7, _MM_FROUND_CUR_DIRECTION));
        }
    }
}
...
void gemm_att_f32a_f16bc_mul_scale_n64(
    ...
    #pragma omp parallel
    {
        ...
        for (size_t ii = 0; ii < M; ++ii) {
            ...
            // 1️⃣ Initialize FP32 accumulators ONCE
